...
RUN apt-get update \
    ...
    rapidjson-dev python-dev libxml2-dev libxslt-dev libscrypt-dev libssl-dev openssl libgmp3-dev autoconf libtool libjsoncpp-dev libjsonrpccpp-dev libjsonrpccpp-tools
