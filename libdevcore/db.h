...
using errinfo_dbStatusCode =
    boost::error_info<struct tag_dbStatusCode, DatabaseStatus>;
using errinfo_dbStatusString =
    boost::error_info<struct tag_dbStatusString, std::string>;
