...
namespace dev {
// Throws UnknownField() if _obj contains field names not listed in
// _allowedFields.
void validateFieldNames(json_spirit::mObject const& _obj,
...
/// Check the json object with validation map that reuires certain field of
/// certain type to be present in json
/**
  @param _o a json object to check
  @param _configName a string with json object name. Will apper in error
  message.
