...
namespace taraxa{
BaseVisitor::BaseVisitor(std::shared_ptr<FullNode> full_node): full_node_(full_node){}

BlockVisitor::BlockVisitor(std::shared_ptr<FullNode> full_node): BaseVisitor(full_node){}
