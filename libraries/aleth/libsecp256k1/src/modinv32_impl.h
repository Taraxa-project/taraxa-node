...
static void secp256k1_modinv32_mul_30(secp256k1_modinv32_signed30 *r, const secp256k1_modinv32_signed30 *a, int alen,
                                      int32_t factor) {
...
static int secp256k1_modinv32_mul_cmp_30(const secp256k1_modinv32_signed30 *a, int alen,
                                         const secp256k1_modinv32_signed30 *b, int32_t factor) {
  int i;
 ...
 * [0,2^30). */
static void secp256k1_modinv32_normalize_30(secp256k1_modinv32_signed30 *r, int32_t sign,
                                            const secp256k1_modinv32_modinfo *modinfo) {
  const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
  int32_t r0 = r->v[0], r1 = r->v[1], r2 = r->v[2], r3 = r->v[3], r4 = r->v[4], r5 = r->v[5], r6 = r->v[6],
          r7 = r->v[7], r8 = r->v[8];
...
static const uint8_t secp256k1_modinv32_inv256[128] = {
    };
 ...
 */
static int32_t secp256k1_modinv32_divsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0,
 ...
 * Return: final eta
 */
static int32_t secp256k1_modinv32_posdivsteps_30_var(int32_t eta, uint32_t f0, uint32_t g0,
                                                     secp256k1_modinv32_trans2x2 *t, int *jacp) {
 ...
 */
static void secp256k1_modinv32_update_de_30(secp256k1_modinv32_signed30 *d, secp256k1_modinv32_signed30 *e,
 ...
 */
static void secp256k1_modinv32_update_fg_30(secp256k1_modinv32_signed30 *f, secp256k1_modinv32_signed30 *g,
                                            const secp256k1_modinv32_trans2x2 *t) {
  const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
  const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
  int32_t fi, gi;
 ...
 */
static void secp256k1_modinv32_update_fg_30_var(int len, secp256k1_modinv32_signed30 *f, secp256k1_modinv32_signed30 *g,
                                                const secp256k1_modinv32_trans2x2 *t) {
  const int32_t M30 = (int32_t)(UINT32_MAX >> 2);
  const int32_t u = t->u, v = t->v, q = t->q, r = t->r;
  int32_t fi, gi;
...
static int secp256k1_jacobi32_maybe_var(const secp256k1_modinv32_signed30 *x,
  ...
  VERIFY_CHECK(g.v[0] >= 0 && g.v[1] >= 0 && g.v[2] >= 0 && g.v[3] >= 0 && g.v[4] >= 0 && g.v[5] >= 0 && g.v[6] >= 0 &&
               g.v[7] >= 0 && g.v[8] >= 0);
  ...
  for (count = 0; count < JACOBI32_ITERATIONS; ++count) {
    ...
    secp256k1_modinv32_trans2x2 t;
    eta = secp256k1_modinv32_posdivsteps_30_var(eta, f.v[0] | ((uint32_t)f.v[1] << 30),
                                                g.v[0] | ((uint32_t)g.v[1] << 30), &t, &jac);
    /* Update f,g using that transition matrix. */
