...
SECP256K1_INLINE static uint64_t rotl(const uint64_t x, int k) { return (x << k) | (x >> (64 - k)); }
...
SECP256K1_INLINE static uint32_t secp256k1_testrand32(void) { return secp256k1_testrand64() >> 32; }
...
static void secp256k1_testrand256_test(unsigned char *b32) { secp256k1_testrand_bytes_test(b32, 32); }
...
static void secp256k1_testrand_init(const char *hexseed) {
  ...
  printf("random seed = %02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x\n", seed16[0], seed16[1],
         seed16[2], seed16[3], seed16[4], seed16[5], seed16[6], seed16[7], seed16[8], seed16[9], seed16[10], seed16[11],
         seed16[12], seed16[13], seed16[14], seed16[15]);
...
static void secp256k1_testrand_finish(void) {
  ...
  printf("random run = %02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x%02x\n", run32[0], run32[1],
         run32[2], run32[3], run32[4], run32[5], run32[6], run32[7], run32[8], run32[9], run32[10], run32[11],
         run32[12], run32[13], run32[14], run32[15]);
}
