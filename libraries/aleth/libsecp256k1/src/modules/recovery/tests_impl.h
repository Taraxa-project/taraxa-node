...
static void test_ecdsa_recovery_edge_cases(void) {
  ...
  const unsigned char sig64[64] = {/* Generated by signing the above message with nonce 'This is the nonce we will
                                    * use...' and secret key 0 (which is not valid), resulting in recid 1. */
