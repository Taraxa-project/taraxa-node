...
SortitionParamsManager::SortitionParamsManager(const addr_t& node_addr, SortitionConfig sort_conf,
  ...
  // Testnet fix hard for incorrect changes
  ...
  SortitionParamsChange period_155450(155450, 7891, vrf_params);
  period_155400.actual_correction_per_percent = 46;
  db_->saveSortitionParamsChange(155450, period_155450, batch);

  vrf_params.threshold_lower = 0;
  vrf_params.threshold_upper = 2756;
  SortitionParamsChange period_155500(155500, 8390, vrf_params);
  period_155400.actual_correction_per_percent = 90;
  db_->saveSortitionParamsChange(155500, period_155500, batch);

  vrf_params.threshold_lower = 0;
  vrf_params.threshold_upper = 3206;
  SortitionParamsChange period_155550(155550, 9831, vrf_params);
  period_155400.actual_correction_per_percent = 31;
  db_->saveSortitionParamsChange(155550, period_155550, batch);

  vrf_params.threshold_lower = 0;
  vrf_params.threshold_upper = 3676;
  ...
  /*
    "result":{"actual_correction_per_percent":655,"interval_efficiency":9875,"k_threshold_range":6144,"k_threshold_upper_min_value":80,"period":155600,"threshold_lower":0,"threshold_upper":3676}}
    "result":{"actual_correction_per_percent":31,"interval_efficiency":9831,"k_threshold_range":6144,"k_threshold_upper_min_value":80,"period":155550,"threshold_lower":0,"threshold_upper":3206}}
    "result":{"actual_correction_per_percent":90,"interval_efficiency":8390,"k_threshold_range":6144,"k_threshold_upper_min_value":80,"period":155500,"threshold_lower":0,"threshold_upper":2756}}
    "result":{"actual_correction_per_percent":46,"interval_efficiency":7891,"k_threshold_range":6144,"k_threshold_upper_min_value":80,"period":155450,"threshold_lower":0,"threshold_upper":2306}}
    "result":{"actual_correction_per_percent":15,"interval_efficiency":6944,"k_threshold_range":6144,"k_threshold_upper_min_value":80,"period":155400,"threshold_lower":0,"threshold_upper":1866}}
  */
