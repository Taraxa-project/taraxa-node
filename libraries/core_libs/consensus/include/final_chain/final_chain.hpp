...
class FinalChain {
  ...
  */
  ...
  /**
  * @brief Executes a new message call immediately without creating a transaction on the block chain. That means that state would be reverted and not saved anywhere 
