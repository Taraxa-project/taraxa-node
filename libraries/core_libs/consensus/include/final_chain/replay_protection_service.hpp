...
class ReplayProtectionService {
 public:
  ...
  ReplayProtectionService() = default;
  virtual ~ReplayProtectionService() = default;
  ReplayProtectionService(const ReplayProtectionService &) = default;
  ReplayProtectionService(ReplayProtectionService &&) = default;
  ReplayProtectionService &operator=(const ReplayProtectionService &) = default;
  ReplayProtectionService &operator=(ReplayProtectionService &&) = default;
