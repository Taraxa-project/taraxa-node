...
class BlockStats {
 public:
  ...
  BlockStats(const PeriodData& block, const std::vector<gas_t>& trxs_gas_used, uint64_t dpos_vote_count,
             ...
             const bool aspen_dag_rewards = false, const bool bamboo_dag_rewards = false);
 ...
 private:
   ...
   * @param dag_blocks_author_level
   */
  void processStats(const PeriodData& block, const bool aspen_dag_rewards, const bool bamboo_dag_rewards,
