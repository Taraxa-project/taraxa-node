...
class OmgGetPbftSyncPacketHandler final : public tarcap::PacketHandler {
 public:
  OmgGetPbftSyncPacketHandler(const FullNodeConfig& conf, std::shared_ptr<tarcap::PeersState> peers_state,
