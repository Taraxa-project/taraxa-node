...
class TestFace : public ServerInterface<TestFace> {
 public:
  TestFace() {
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("tps_test", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, NULL),
  ...
  inline virtual void tps_testI(const Json::Value &, Json::Value &response) { response = this->tps_test(); }
