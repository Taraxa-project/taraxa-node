...
#include "network/tarcap/capability_v1/packets_handlers/get_next_votes_sync_packet_handler.hpp"
#include "network/tarcap/capability_v1/packets_handlers/get_pbft_sync_packet_handler.hpp"
#include "network/tarcap/capability_v1/packets_handlers/pbft_sync_packet_handler.hpp"
#include "network/tarcap/capability_v1/packets_handlers/votes_bundle_packet_handler.hpp"
...
void TaraxaCapability::registerPacketHandlers(
  ...
  packets_handlers_->registerHandler<tarcap::v1::GetNextVotesBundlePacketHandler>(
      kConf, peers_state_, packets_stats, pbft_mgr, pbft_chain, vote_mgr, node_addr);
  packets_handlers_->registerHandler<tarcap::v1::VotesBundlePacketHandler>(kConf, peers_state_, packets_stats, pbft_mgr,
                                                                           pbft_chain, vote_mgr, node_addr);
  ...
  packets_handlers_->registerHandler<tarcap::v1::GetPbftSyncPacketHandler>(
