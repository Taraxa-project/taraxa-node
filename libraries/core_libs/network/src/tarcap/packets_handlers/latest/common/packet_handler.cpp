...
// }
//
// void PacketHandler::processPacket(const PacketType& packet_data) {
//   try {
...
//
//     // TODO: call decode function and remove checkPacketRlpIsList & validatePacketRlpFormat
//     PacketType packet{packet_data};
//     packet.decocode();
//
//     // Main processing function
//     process(packet, peer.first);
//
...
// }
//
// void PacketHandler::handle_caught_exception(std::string_view exception_msg, const threadpool::PacketData&
// packet_data,
//                                             const dev::p2p::NodeID& peer, dev::p2p::DisconnectReason
//                                             disconnect_reason, bool set_peer_as_malicious) {
