...
//                                              std::shared_ptr<SlashingManager> slashing_manager, const addr_t
//                                              &node_addr, const std::string &log_channel_name)
...
// }
//
// std::pair<bool, std::string> ExtVotesPacketHandler::validateVotePeriodRoundStep(const std::shared_ptr<PbftVote>
// &vote,
//                                                                                 const std::shared_ptr<TaraxaPeer>
//                                                                                 &peer, bool validate_max_round_step)
//                                                                                 {
...
//     err << "Vote " << vote->getHash() << " (period, round, step) = (" << vote->getPeriod() << ", " <<
//     vote->getRound()
