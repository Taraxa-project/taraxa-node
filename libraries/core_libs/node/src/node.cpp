...
void FullNode::init() {
  ...
  dag_mgr_ =
      std::make_shared<DagManager>(conf_.genesis.dag_genesis_block, node_addr, conf_.genesis.sortition, conf_.genesis.dag,
  ...
  pbft_mgr_ =
      std::make_shared<PbftManager>(conf_.genesis.pbft,  conf_.genesis.dag_genesis_block.getHash(), node_addr, db_, pbft_chain_, vote_mgr_,
