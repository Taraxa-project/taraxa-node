...
Json::Value enc_json(const HardforksConfig& obj) {
  ...
  json["cora_hf_block_num"] = dev::toJS(obj.cora_hf_block_num);
...
void dec_json(const Json::Value& json, HardforksConfig& obj) {
  ...
  obj.cora_hf_block_num = dev::getUInt(json["cora_hf_block_num"]);
...
RLP_FIELDS_DEFINE(HardforksConfig, fix_redelegate_block_num, cora_hf_block_num, redelegations,
