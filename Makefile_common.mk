...
ifneq ($(SYSTEM_HOME_OVERRIDE),)
	...
	ifneq ($(SHELL_PATH_EXTRA),)
		SHELL_PATH_EXTRA := $(SYSTEM_HOME_OVERRIDE)/bin:$(SHELL_PATH_EXTRA)
	else
		SHELL_PATH_EXTRA := $(SYSTEM_HOME_OVERRIDE)/bin
	endif
endif
ifneq ($(SHELL_PATH_EXTRA),)
	SHELL := PATH=$(SHELL_PATH_EXTRA):$(shell echo $$PATH) $(SHELL)
endif
