...
struct NetworkConfig {
  ...
  NetworkConfig(std::string const& _listenAddress,
                ...
                bool _upnp = true, bool _allowLocalDiscovery = false)
      : publicIPAddress(),
  ...
  NetworkConfig(std::string const& _publicIP,
  ...
  bool allowLocalDiscovery =
      false;  // Include nodes with local IP addresses in the discovery process.
...
class Network {
 public:
  ...
  static int tcp4Listen(bi::tcp::acceptor& _acceptor,
  ...
  /// and port.
  static bi::tcp::endpoint traverseNAT(
