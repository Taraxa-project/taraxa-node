...
class CapabilityFace {
 public:
  ...
  /// this peer.
  virtual void onConnect(NodeID const& _nodeID,
                         u256 const& _peerCapabilityVersion) = 0;
  ...
  /// supported type.
  virtual bool interpretCapabilityPacket(NodeID const& _nodeID, unsigned _id,
                                         RLP const&) = 0;
