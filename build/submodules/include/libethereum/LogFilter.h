...
#pragma warning( \
    disable : 1098)  // the qualifier on this friend declaration is ignored
#endif
...
class LogFilter {
 public:
  LogFilter(BlockNumber _earliest, BlockNumber _latest)
  ...
  friend std::ostream& dev::eth::operator<<(std::ostream& _out,
