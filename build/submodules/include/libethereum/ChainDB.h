...
struct ChainDB {
  ...
  virtual TransactionReceipt transactionReceipt(h256 const& _blockHash,
                                                unsigned _i) const = 0;
  virtual TransactionReceipt transactionReceipt(
  ...
  virtual bool isKnownTransaction(h256 const& _blockHash,
                                  unsigned _i) const = 0;
  virtual LocalisedLogEntries logs(LogFilter const& _filter) const = 0;
  virtual Transaction transaction(h256 _transactionHash) const = 0;
  virtual Transaction transaction(h256 _blockHash, unsigned _i) const = 0;
  virtual LocalisedTransaction localisedTransaction(unsigned _i,
                                                    BlockNumber n) const = 0;
  virtual LocalisedTransaction localisedTransaction(h256 const& _blockHash,
                                                    unsigned _i) const = 0;
