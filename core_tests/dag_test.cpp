...
TEST(Dag, build_graph){
	...
	auto v0= graph.addVertex(blk_hash_t("100"));
	auto v1= graph.addVertex(blk_hash_t("11111"));
	auto v2= graph.addVertex(blk_hash_t("2888"));
	auto v3= graph.addVertex(blk_hash_t("35"));
...
TEST(Dag, traversal){
	...
	auto v3 = graph.addVertex(blk_hash_t("35"));
	// unconnected vertex
	auto v4 = graph.addVertex(blk_hash_t("999")); 
