...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2flogging_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2flogging_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2flogging_2eproto 
...
class Logging_LoggingDestination : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Logging.LoggingDestination) */ {
 public:
  ...
  inline Logging_LoggingDestination* New() const final {
    return CreateMaybeMessage<Logging_LoggingDestination>(NULL);
  }

  Logging_LoggingDestination* New(::google::protobuf::Arena* arena) const final {
...
class Logging : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Logging) */ {
 public:
  ...
  inline Logging* New() const final {
    return CreateMaybeMessage<Logging>(NULL);
  }

  Logging* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2flogging_2eproto
