...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fservicemanagement_2fv1_2fresources_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fservicemanagement_2fv1_2fresources_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fservicemanagement_2fv1_2fresources_2eproto 
...
const ConfigFile_FileType ConfigFile_FileType_FileType_MAX = ConfigFile_FileType_PROTO_FILE;
...
const Rollout_RolloutStatus Rollout_RolloutStatus_RolloutStatus_MAX = Rollout_RolloutStatus_FAILED_ROLLED_BACK;
...
class ManagedService : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.ManagedService) */ {
 public:
  ...
  inline ManagedService* New() const final {
    return CreateMaybeMessage<ManagedService>(NULL);
  }

  ManagedService* New(::google::protobuf::Arena* arena) const final {
...
class OperationMetadata_Step : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.OperationMetadata.Step) */ {
 public:
  ...
  inline OperationMetadata_Step* New() const final {
    return CreateMaybeMessage<OperationMetadata_Step>(NULL);
  }

  OperationMetadata_Step* New(::google::protobuf::Arena* arena) const final {
...
class Diagnostic : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.Diagnostic) */ {
 public:
  ...
  inline Diagnostic* New() const final {
    return CreateMaybeMessage<Diagnostic>(NULL);
  }

  Diagnostic* New(::google::protobuf::Arena* arena) const final {
...
class ConfigSource : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.ConfigSource) */ {
 public:
  ...
  inline ConfigSource* New() const final {
    return CreateMaybeMessage<ConfigSource>(NULL);
  }

  ConfigSource* New(::google::protobuf::Arena* arena) const final {
...
class ConfigFile : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.ConfigFile) */ {
 public:
  ...
  inline ConfigFile* New() const final {
    return CreateMaybeMessage<ConfigFile>(NULL);
  }
  ...
  static const FileType PROTO_FILE =
...
class ConfigRef : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.ConfigRef) */ {
 public:
  ...
  inline ConfigRef* New() const final {
    return CreateMaybeMessage<ConfigRef>(NULL);
  }

  ConfigRef* New(::google::protobuf::Arena* arena) const final {
...
class ChangeReport : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.ChangeReport) */ {
 public:
  ...
  inline ChangeReport* New() const final {
    return CreateMaybeMessage<ChangeReport>(NULL);
  }

  ChangeReport* New(::google::protobuf::Arena* arena) const final {
...
class Rollout_TrafficPercentStrategy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy) */ {
 public:
  ...
  inline Rollout_TrafficPercentStrategy* New() const final {
    return CreateMaybeMessage<Rollout_TrafficPercentStrategy>(NULL);
  }

  Rollout_TrafficPercentStrategy* New(::google::protobuf::Arena* arena) const final {
...
class Rollout_DeleteServiceStrategy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy) */ {
 public:
  ...
  inline Rollout_DeleteServiceStrategy* New() const final {
    return CreateMaybeMessage<Rollout_DeleteServiceStrategy>(NULL);
  }

  Rollout_DeleteServiceStrategy* New(::google::protobuf::Arena* arena) const final {
...
class Rollout : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.Rollout) */ {
 public:
  ...
  inline Rollout* New() const final {
    return CreateMaybeMessage<Rollout>(NULL);
  }

  Rollout* New(::google::protobuf::Arena* arena) const final {
  ...
  static const RolloutStatus FAILED_ROLLED_BACK =
...
inline const ::google::protobuf::Timestamp& Rollout::_internal_create_time() const {
  return *create_time_;
}
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fservicemanagement_2fv1_2fresources_2eproto
