...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fendpoint_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fendpoint_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fendpoint_2eproto 
...
class Endpoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Endpoint) */ {
 public:
  ...
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void set_aliases(int index, ::std::string&& value);
  #endif
  ...
  #if LANG_CXX11
  GOOGLE_PROTOBUF_DEPRECATED_ATTR void add_aliases(::std::string&& value);
  #endif
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fendpoint_2eproto
