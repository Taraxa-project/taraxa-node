...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/endpoint.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Endpoint& Endpoint::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fendpoint_2eproto::scc_info_Endpoint.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::Endpoint* Arena::CreateMaybeMessage< ::google::api::Endpoint >(Arena* arena) {
