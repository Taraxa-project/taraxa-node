...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fexpr_2fv1alpha1_2fvalue_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fexpr_2fv1alpha1_2fvalue_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fexpr_2fv1alpha1_2fvalue_2eproto 
...
class Value : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.Value) */ {
 public:
  Value();
  virtual ~Value();
 ...
 private:
  ...
  friend struct ::protobuf_google_2fapi_2fexpr_2fv1alpha1_2fvalue_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class EnumValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.EnumValue) */ {
 public:
  EnumValue();
  virtual ~EnumValue();
...
class ListValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.ListValue) */ {
 public:
  ListValue();
  virtual ~ListValue();
...
class MapValue_Entry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.MapValue.Entry) */ {
 public:
  MapValue_Entry();
...
class MapValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.expr.v1alpha1.MapValue) */ {
 public:
  MapValue();
  virtual ~MapValue();
...
inline const ::google::api::expr::v1alpha1::Value& MapValue_Entry::key() const {
  ...
  return p != NULL ? *p : *reinterpret_cast<const ::google::api::expr::v1alpha1::Value*>(
...
inline ::google::api::expr::v1alpha1::Value* MapValue_Entry::unsafe_arena_release_key() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.api.expr.v1alpha1.MapValue.Entry.key)
...
inline ::google::api::expr::v1alpha1::Value* MapValue_Entry::unsafe_arena_release_value() {
  // @@protoc_insertion_point(field_unsafe_arena_release:google.api.expr.v1alpha1.MapValue.Entry.value)
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fexpr_2fv1alpha1_2fvalue_2eproto
