...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fbilling_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fbilling_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fbilling_2eproto 
...
class Billing_BillingDestination : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Billing.BillingDestination) */ {
 public:
  ...
  inline Billing_BillingDestination* New() const final {
    return CreateMaybeMessage<Billing_BillingDestination>(NULL);
  }

  Billing_BillingDestination* New(::google::protobuf::Arena* arena) const final {
...
class Billing : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Billing) */ {
 public:
  ...
  inline Billing* New() const final {
    return CreateMaybeMessage<Billing>(NULL);
  }

  Billing* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fbilling_2eproto
