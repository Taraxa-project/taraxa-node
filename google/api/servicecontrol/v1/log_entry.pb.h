...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto 
...
class LogEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicecontrol.v1.LogEntry) */ {
 public:
  ...
  private:
  const ::google::protobuf::Struct& _internal_struct_payload() const;
  public:
...
inline void LogEntry::set_text_payload(::std::string&& value) {
  ...
  payload_.text_payload_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void LogEntry::set_allocated_text_payload(::std::string* text_payload) {
  ...
  if (text_payload != NULL) {
    set_has_text_payload();
    payload_.text_payload_.SetAllocatedNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), text_payload);
  }
...
inline const ::google::protobuf::Struct& LogEntry::_internal_struct_payload() const {
...
inline ::google::protobuf::Struct* LogEntry::mutable_struct_payload() {
  if (!has_struct_payload()) {
    ...
    payload_.struct_payload_ = CreateMaybeMessage< ::google::protobuf::Struct >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fservicecontrol_2fv1_2flog_5fentry_2eproto
