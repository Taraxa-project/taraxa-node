...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fbilling_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Billing_BillingDestination;
}  // namespace protobuf_google_2fapi_2fbilling_2eproto
namespace google {
namespace api {
...
namespace protobuf_google_2fapi_2fbilling_2eproto {
static void InitDefaultsBilling_BillingDestination() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_Billing_BillingDestination =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsBilling_BillingDestination}, {}};

static void InitDefaultsBilling() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_Billing =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsBilling}, {
      &protobuf_google_2fapi_2fbilling_2eproto::scc_info_Billing_BillingDestination.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Billing_BillingDestination.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Billing.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/billing.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Billing_BillingDestination& Billing_BillingDestination::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fbilling_2eproto::scc_info_Billing_BillingDestination.base);
...
const Billing& Billing::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fbilling_2eproto::scc_info_Billing.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::Billing_BillingDestination* Arena::CreateMaybeMessage< ::google::api::Billing_BillingDestination >(Arena* arena) {
  return Arena::CreateInternal< ::google::api::Billing_BillingDestination >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::Billing* Arena::CreateMaybeMessage< ::google::api::Billing >(Arena* arena) {
