...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/source_info.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SourceInfo& SourceInfo::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fsource_5finfo_2eproto::scc_info_SourceInfo.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::SourceInfo* Arena::CreateMaybeMessage< ::google::api::SourceInfo >(Arena* arena) {
