...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fusage_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fusage_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fusage_2eproto 
...
class Usage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.Usage) */ {
 public:
  ...
  inline Usage* New() const final {
    return CreateMaybeMessage<Usage>(NULL);
  }

  Usage* New(::google::protobuf::Arena* arena) const final {
...
class UsageRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.UsageRule) */ {
 public:
  ...
  inline UsageRule* New() const final {
    return CreateMaybeMessage<UsageRule>(NULL);
  }

  UsageRule* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fusage_2eproto
