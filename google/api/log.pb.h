...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2flog_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2flog_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2flog_2eproto 
...
class LogDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.LogDescriptor) */ {
 public:
  ...
  inline LogDescriptor* New() const final {
    return CreateMaybeMessage<LogDescriptor>(NULL);
  }

  LogDescriptor* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2flog_2eproto
