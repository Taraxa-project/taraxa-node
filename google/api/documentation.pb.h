...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fdocumentation_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fdocumentation_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fdocumentation_2eproto 
...
class DocumentationRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.DocumentationRule) */ {
 public:
  ...
  inline DocumentationRule* New() const final {
    return CreateMaybeMessage<DocumentationRule>(NULL);
  }

  DocumentationRule* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fdocumentation_2eproto
