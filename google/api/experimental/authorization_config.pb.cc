...
static void InitDefaultsAuthorizationConfig() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_AuthorizationConfig =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsAuthorizationConfig}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_AuthorizationConfig.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/experimental/authorization_config.proto", schemas, file_default_instances, TableStruct::offsets,
...
const AuthorizationConfig& AuthorizationConfig::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fexperimental_2fauthorization_5fconfig_2eproto::scc_info_AuthorizationConfig.base);
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::AuthorizationConfig* Arena::CreateMaybeMessage< ::google::api::AuthorizationConfig >(Arena* arena) {
