...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fsystem_5fparameter_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_SystemParameter;
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fsystem_5fparameter_2eproto ::google::protobuf::internal::SCCInfo<1> scc_info_SystemParameterRule;
}  // namespace protobuf_google_2fapi_2fsystem_5fparameter_2eproto
namespace google {
namespace api {
...
namespace protobuf_google_2fapi_2fsystem_5fparameter_2eproto {
static void InitDefaultsSystemParameters() {
...
::google::protobuf::internal::SCCInfo<1> scc_info_SystemParameters =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsSystemParameters}, {
      &protobuf_google_2fapi_2fsystem_5fparameter_2eproto::scc_info_SystemParameterRule.base,}};

static void InitDefaultsSystemParameterRule() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_SystemParameterRule =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsSystemParameterRule}, {
      &protobuf_google_2fapi_2fsystem_5fparameter_2eproto::scc_info_SystemParameter.base,}};

static void InitDefaultsSystemParameter() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<0> scc_info_SystemParameter =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsSystemParameter}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_SystemParameters.base);
  ::google::protobuf::internal::InitSCC(&scc_info_SystemParameterRule.base);
  ::google::protobuf::internal::InitSCC(&scc_info_SystemParameter.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/system_parameter.proto", schemas, file_default_instances, TableStruct::offsets,
...
const SystemParameters& SystemParameters::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fsystem_5fparameter_2eproto::scc_info_SystemParameters.base);
...
const SystemParameterRule& SystemParameterRule::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fsystem_5fparameter_2eproto::scc_info_SystemParameterRule.base);
  return *internal_default_instance();
}
...
const SystemParameter& SystemParameter::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fsystem_5fparameter_2eproto::scc_info_SystemParameter.base);
  return *internal_default_instance();
}
...
void SystemParameter::InternalSwap(SystemParameter* other) {
  ...
  name_.Swap(&other->name_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  http_header_.Swap(&other->http_header_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  url_query_parameter_.Swap(&other->url_query_parameter_, &::google::protobuf::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  _internal_metadata_.Swap(&other->_internal_metadata_);
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::SystemParameters* Arena::CreateMaybeMessage< ::google::api::SystemParameters >(Arena* arena) {
  return Arena::CreateInternal< ::google::api::SystemParameters >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::SystemParameterRule* Arena::CreateMaybeMessage< ::google::api::SystemParameterRule >(Arena* arena) {
  return Arena::CreateInternal< ::google::api::SystemParameterRule >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::SystemParameter* Arena::CreateMaybeMessage< ::google::api::SystemParameter >(Arena* arena) {
