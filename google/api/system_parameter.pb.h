...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2fsystem_5fparameter_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2fsystem_5fparameter_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fsystem_5fparameter_2eproto 
...
class SystemParameters : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.SystemParameters) */ {
 public:
  ...
  inline SystemParameters* New() const final {
    return CreateMaybeMessage<SystemParameters>(NULL);
  }

  SystemParameters* New(::google::protobuf::Arena* arena) const final {
...
class SystemParameterRule : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.SystemParameterRule) */ {
 public:
  ...
  inline SystemParameterRule* New() const final {
    return CreateMaybeMessage<SystemParameterRule>(NULL);
  }

  SystemParameterRule* New(::google::protobuf::Arena* arena) const final {
...
class SystemParameter : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.SystemParameter) */ {
 public:
  ...
  inline SystemParameter* New() const final {
    return CreateMaybeMessage<SystemParameter>(NULL);
  }

  SystemParameter* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2fsystem_5fparameter_2eproto
