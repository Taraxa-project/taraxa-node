...
extern PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2fmonitoring_2eproto ::google::protobuf::internal::SCCInfo<0> scc_info_Monitoring_MonitoringDestination;
}  // namespace protobuf_google_2fapi_2fmonitoring_2eproto
namespace google {
namespace api {
...
namespace protobuf_google_2fapi_2fmonitoring_2eproto {
static void InitDefaultsMonitoring_MonitoringDestination() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_Monitoring_MonitoringDestination =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsMonitoring_MonitoringDestination}, {}};

static void InitDefaultsMonitoring() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::google::protobuf::internal::SCCInfo<1> scc_info_Monitoring =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 1, InitDefaultsMonitoring}, {
      &protobuf_google_2fapi_2fmonitoring_2eproto::scc_info_Monitoring_MonitoringDestination.base,}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_Monitoring_MonitoringDestination.base);
  ::google::protobuf::internal::InitSCC(&scc_info_Monitoring.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/monitoring.proto", schemas, file_default_instances, TableStruct::offsets,
...
const Monitoring_MonitoringDestination& Monitoring_MonitoringDestination::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fmonitoring_2eproto::scc_info_Monitoring_MonitoringDestination.base);
...
const Monitoring& Monitoring::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2fmonitoring_2eproto::scc_info_Monitoring.base);
  return *internal_default_instance();
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::Monitoring_MonitoringDestination* Arena::CreateMaybeMessage< ::google::api::Monitoring_MonitoringDestination >(Arena* arena) {
  return Arena::CreateInternal< ::google::api::Monitoring_MonitoringDestination >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::Monitoring* Arena::CreateMaybeMessage< ::google::api::Monitoring >(Arena* arena) {
