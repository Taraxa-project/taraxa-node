...
static void InitDefaultsLabelDescriptor() {
...
::google::protobuf::internal::SCCInfo<0> scc_info_LabelDescriptor =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 0, InitDefaultsLabelDescriptor}, {}};

void InitDefaults() {
  ::google::protobuf::internal::InitSCC(&scc_info_LabelDescriptor.base);
}
...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "google/api/label.proto", schemas, file_default_instances, TableStruct::offsets,
...
LabelDescriptor::LabelDescriptor(::google::protobuf::Arena* arena)
  ...
  ::google::protobuf::internal::InitSCC(&protobuf_google_2fapi_2flabel_2eproto::scc_info_LabelDescriptor.base);
  SharedCtor();
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::google::api::LabelDescriptor* Arena::CreateMaybeMessage< ::google::api::LabelDescriptor >(Arena* arena) {
