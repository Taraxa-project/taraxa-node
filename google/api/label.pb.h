...
#ifndef PROTOBUF_INCLUDED_google_2fapi_2flabel_2eproto
#define PROTOBUF_INCLUDED_google_2fapi_2flabel_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_google_2fapi_2flabel_2eproto 
...
class LabelDescriptor : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.LabelDescriptor) */ {
 public:
  ...
  inline LabelDescriptor* New() const final {
    return CreateMaybeMessage<LabelDescriptor>(NULL);
  }

  LabelDescriptor* New(::google::protobuf::Arena* arena) const final {
...
#endif  // PROTOBUF_INCLUDED_google_2fapi_2flabel_2eproto
