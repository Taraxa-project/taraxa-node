...
class GrpcService final : public taraxa_grpc::TaraxaProtoService::Service {
 public:
  ...
  void start();
  void stop();
  ::grpc::Status SendProtoTransaction(
      ::grpc::ServerContext* context,
      const ::taraxa_grpc::ProtoTransaction* request,
      ::taraxa_grpc::SendProtoTransactionResponse* response) override;
  ::grpc::Status GetProtoTransaction(
      ::grpc::ServerContext* context,
      const ::taraxa_grpc::GetProtoTransactionRequest* request,
      ::taraxa_grpc::ProtoTransaction* response) override;
