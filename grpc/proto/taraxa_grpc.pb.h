...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_proto_2ftaraxa_5fgrpc_2eproto 
...
class ProtoTransaction : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:taraxa_grpc.ProtoTransaction) */ {
 public:
  ProtoTransaction();
  ...
  inline ProtoTransaction* New() const final {
    return CreateMaybeMessage<ProtoTransaction>(NULL);
  }
 ...
 private:
  ...
  friend struct ::protobuf_proto_2ftaraxa_5fgrpc_2eproto::TableStruct;
};
// -------------------------------------------------------------------

class SendProtoTransactionResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:taraxa_grpc.SendProtoTransactionResponse) */ {
 public:
  ...
  inline SendProtoTransactionResponse* New() const final {
    return CreateMaybeMessage<SendProtoTransactionResponse>(NULL);
  }
...
class GetProtoTransactionRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:taraxa_grpc.GetProtoTransactionRequest) */ {
 public:
  ...
  inline GetProtoTransactionRequest* New() const final {
    return CreateMaybeMessage<GetProtoTransactionRequest>(NULL);
  }
