...
libff::bigint<libff::alt_bn128_q_limbs> toLibsnarkBigint(h256 const& _x) {
  ...
  static_assert(sizeof(mp_limb_t) == L,
...
libff::alt_bn128_Fq2 decodeFq2Element(dev::bytesConstRef _data) {
  ...
  return libff::alt_bn128_Fq2(decodeFqElement(_data.cropped(32)),
...
pair<bool, bytes> dev::crypto::alt_bn128_pairing_product(
    dev::bytesConstRef _in) {
  ...
  try {
    ...
    for (size_t i = 0; i < pairs; ++i) {
      ...
      if (-libff::alt_bn128_G2::scalar_field::one() * p + p !=
      ...
      x = x * libff::alt_bn128_miller_loop(libff::alt_bn128_precompute_G1(g1),
