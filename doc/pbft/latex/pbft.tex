...
\begin{document}
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            \item[--] If $r = 1$ or if $r > 1$ and $u$ has received received 2t+1 \text{ next-votes for } $\bot$, then $u$ selects the proposal with the minimum credential and soft-votes for it.
