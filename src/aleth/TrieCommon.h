...
inline bool isLeaf(dev::RLP const& _twoItem) {
...
inline NibbleSlice keyOf(dev::RLP const& _twoItem) { return keyOf(_twoItem[0].payload()); }

::byte uniqueInUse(dev::RLP const& _orig, ::byte except);
