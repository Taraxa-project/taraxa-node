...
class GetDagSyncPacketsHandler : public PacketHandler {
 public:
  GetDagSyncPacketsHandler(std::shared_ptr<PeersState> peers_state, std::shared_ptr<PacketsStats> packets_stats,
  ...
  virtual ~GetDagSyncPacketsHandler() = default;
