        ...
        class TestFace : public ServerInterface<TestFace>
        {
            public:
                TestFace()
                {
                    ...
                    this->bindAndAddMethod(jsonrpc::Procedure("get_account_address", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_account_addressI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_account_balance", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_account_balanceI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_node_count", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_node_countI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_peer_count", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_peer_countI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_node_status", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_node_statusI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_node_version", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_node_versionI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_all_peers", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_all_peersI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_all_nodes", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_all_nodesI);
                    this->bindAndAddMethod(jsonrpc::Procedure("should_speak", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::should_speakI);
                    this->bindAndAddMethod(jsonrpc::Procedure("place_vote", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::place_voteI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_votes", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_votesI);
                    this->bindAndAddMethod(jsonrpc::Procedure("draw_graph", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::draw_graphI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_transaction_count", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_transaction_countI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_executed_trx_count", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_executed_trx_countI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_executed_blk_count", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_executed_blk_countI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_dag_size", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_dag_sizeI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_dag_blk_count", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_dag_blk_countI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_pbft_chain_size", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,  NULL), &taraxa::net::TestFace::get_pbft_chain_sizeI);
                    this->bindAndAddMethod(jsonrpc::Procedure("get_pbft_chain_blocks", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param1",jsonrpc::JSON_OBJECT, NULL), &taraxa::net::TestFace::get_pbft_chain_blocksI);
                }
