...
std::future<service::ResolverResult> Query::resolveBlock(service::ResolverParams&& params) {
  ...
  std::unique_lock resolverLock(_resolverMutex);
  auto directives = std::move(params.fieldDirectives);
  auto result = getBlock(service::FieldParams(std::move(params), std::move(directives)), std::move(argNumber),
                         std::move(argHash));
  resolverLock.unlock();
...
std::future<service::ResolverResult> Query::resolveBlocks(service::ResolverParams&& params) {
  ...
  auto directives = std::move(params.fieldDirectives);
  auto result =
      getBlocks(service::FieldParams(std::move(params), std::move(directives)), std::move(argFrom), std::move(argTo));
  resolverLock.unlock();
...
std::future<service::ResolverResult> Mutation::resolveSendRawTransaction(service::ResolverParams&& params) {
  ...
  auto directives = std::move(params.fieldDirectives);
  auto result =
      applySendRawTransaction(service::FieldParams(std::move(params), std::move(directives)), std::move(argData));
  resolverLock.unlock();
