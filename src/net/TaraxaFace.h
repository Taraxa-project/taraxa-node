...
class TaraxaFace : public ServerInterface<TaraxaFace> {
 public:
  TaraxaFace() {
    ...
    this->bindAndAddMethod(
        jsonrpc::Procedure("taraxa_getDagBlockByHash", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",
                           jsonrpc::JSON_STRING, "param02", jsonrpc::JSON_BOOLEAN, NULL),
        &taraxa::net::TaraxaFace::taraxa_getDagBlockByHashI);
    this->bindAndAddMethod(
        jsonrpc::Procedure("taraxa_getDagBlockByLevel", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",
                           jsonrpc::JSON_STRING, "param02", jsonrpc::JSON_BOOLEAN, NULL),
  ...
  virtual Json::Value taraxa_getDagBlockByHash(const std::string &param01, bool param02) = 0;
  virtual Json::Value taraxa_getDagBlockByLevel(const std::string &param01, bool param02) = 0;
  virtual std::string taraxa_dagBlockLevel() = 0;
  virtual std::string taraxa_dagBlockPeriod() = 0;
  virtual Json::Value taraxa_getScheduleBlockByPeriod(const std::string &param01) = 0;
  virtual Json::Value taraxa_getConfig() = 0;
  virtual Json::Value taraxa_queryDPOS(const Json::Value &param01) = 0;
};
