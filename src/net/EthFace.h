 ...
 public:
  EthFace() {
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBalance", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,
                                              "param01", jsonrpc::JSON_STRING, "param02", jsonrpc::JSON_STRING, NULL),
                           &taraxa::net::EthFace::eth_getBalanceI);
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getStorageAt", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,
    ...
    this->bindAndAddMethod(
        jsonrpc::Procedure("eth_getTransactionCount", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",
                           jsonrpc::JSON_STRING, "param02", jsonrpc::JSON_STRING, NULL),
        &taraxa::net::EthFace::eth_getTransactionCountI);
    this->bindAndAddMethod(
        jsonrpc::Procedure("eth_pendingTransactions", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_ARRAY, NULL),
        &taraxa::net::EthFace::eth_pendingTransactionsI);
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_sendTransaction", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING,
                                              "param01", jsonrpc::JSON_OBJECT, NULL),
                           &taraxa::net::EthFace::eth_sendTransactionI);
    this->bindAndAddMethod(jsonrpc::Procedure("eth_call", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_STRING, "param01",
                                              jsonrpc::JSON_OBJECT, "param02", jsonrpc::JSON_STRING, NULL),
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("eth_getBlockByHash", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                                              "param01", jsonrpc::JSON_STRING, "param02", jsonrpc::JSON_BOOLEAN, NULL),
  ...
  virtual std::string eth_getBalance(const std::string &param01, const std::string &param02) = 0;
  virtual std::string eth_getStorageAt(const std::string &param01, const std::string &param02,
                                       const std::string &param03) = 0;
  virtual std::string eth_getStorageRoot(const std::string &param01, const std::string &param02) = 0;
  ...
  virtual Json::Value eth_getBlockTransactionCountByHash(const std::string &param01) = 0;
  virtual Json::Value eth_getBlockTransactionCountByNumber(const std::string &param01) = 0;
  virtual Json::Value eth_getUncleCountByBlockHash(const std::string &param01) = 0;
  virtual Json::Value eth_getUncleCountByBlockNumber(const std::string &param01) = 0;
  virtual std::string eth_getCode(const std::string &param01, const std::string &param02) = 0;
  virtual std::string eth_sendTransaction(const Json::Value &param01) = 0;
  virtual std::string eth_call(const Json::Value &param01, const std::string &param02) = 0;
  virtual Json::Value eth_getBlockByHash(const std::string &param01, bool param02) = 0;
  virtual Json::Value eth_getBlockByNumber(const std::string &param01, bool param02) = 0;
  virtual Json::Value eth_getTransactionByHash(const std::string &param01) = 0;
  virtual Json::Value eth_getTransactionByBlockHashAndIndex(const std::string &param01, const std::string &param02) = 0;
  virtual Json::Value eth_getTransactionByBlockNumberAndIndex(const std::string &param01,
                                                              const std::string &param02) = 0;
  virtual Json::Value eth_getTransactionReceipt(const std::string &param01) = 0;
  virtual Json::Value eth_getUncleByBlockHashAndIndex(const std::string &param01, const std::string &param02) = 0;
  virtual Json::Value eth_getUncleByBlockNumberAndIndex(const std::string &param01, const std::string &param02) = 0;
  virtual std::string eth_newFilter(const Json::Value &param01) = 0;
  virtual std::string eth_newBlockFilter() = 0;
  virtual std::string eth_newPendingTransactionFilter() = 0;
  virtual bool eth_uninstallFilter(const std::string &param01) = 0;
  virtual Json::Value eth_getFilterChanges(const std::string &param01) = 0;
  virtual Json::Value eth_getFilterLogs(const std::string &param01) = 0;
  virtual Json::Value eth_getLogs(const Json::Value &param01) = 0;
  virtual std::string eth_sendRawTransaction(const std::string &param01) = 0;
  virtual Json::Value eth_syncing() = 0;
  virtual std::string eth_estimateGas(const Json::Value &param01) = 0;
