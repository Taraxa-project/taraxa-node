...
std::future<service::ResolverResult> Transaction::resolveCreatedContract(service::ResolverParams&& params)
{
	auto argBlock = service::ModifiedArgument<response::Value>::require<service::TypeModifier::Nullable>("block", params.arguments);
	std::unique_lock resolverLock(_resolverMutex);
	auto result = getCreatedContract(service::FieldParams(params, std::move(params.fieldDirectives)), std::move(argBlock));
	resolverLock.unlock();
...
std::future<service::ResolverResult> Query::resolveBlock(service::ResolverParams&& params)
{
	...
	std::unique_lock resolverLock(_resolverMutex);
	auto result = getBlock(service::FieldParams(params, std::move(params.fieldDirectives)), std::move(argNumber), std::move(argHash));
	resolverLock.unlock();
...
std::future<service::ResolverResult> Query::resolveBlocks(service::ResolverParams&& params)
{
	...
	std::unique_lock resolverLock(_resolverMutex);
	auto result = getBlocks(service::FieldParams(params, std::move(params.fieldDirectives)), std::move(argFrom), std::move(argTo));
	resolverLock.unlock();
...
std::future<service::ResolverResult> Mutation::resolveSendRawTransaction(service::ResolverParams&& params)
{
	...
	std::unique_lock resolverLock(_resolverMutex);
	auto result = applySendRawTransaction(service::FieldParams(params, std::move(params.fieldDirectives)), std::move(argData));
	resolverLock.unlock();
