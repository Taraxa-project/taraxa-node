...
class TestFace : public ServerInterface<TestFace> {
 public:
  TestFace() {
    ...
    this->bindAndAddMethod(jsonrpc::Procedure("place_vote", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                                              "param01", jsonrpc::JSON_OBJECT, NULL),
                           &taraxa::net::TestFace::place_voteI);
    this->bindAndAddMethod(jsonrpc::Procedure("get_votes", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT, "param01",
                                              jsonrpc::JSON_OBJECT, NULL),
                           &taraxa::net::TestFace::get_votesI);
    this->bindAndAddMethod(jsonrpc::Procedure("draw_graph", jsonrpc::PARAMS_BY_POSITION, jsonrpc::JSON_OBJECT,
                                              "param01", jsonrpc::JSON_OBJECT, NULL),
  ...
  virtual Json::Value insert_dag_block(const Json::Value &param01) = 0;
  virtual Json::Value get_dag_block(const Json::Value &param01) = 0;
  virtual Json::Value send_coin_transaction(const Json::Value &param01) = 0;
  virtual Json::Value create_test_coin_transactions(const Json::Value &param01) = 0;
  virtual Json::Value get_num_proposed_blocks() = 0;
  virtual Json::Value get_account_address() = 0;
  virtual Json::Value get_account_balance(const Json::Value &param01) = 0;
  ...
  virtual Json::Value should_speak(const Json::Value &param01) = 0;
  virtual Json::Value place_vote(const Json::Value &param01) = 0;
  virtual Json::Value get_votes(const Json::Value &param01) = 0;
  virtual Json::Value draw_graph(const Json::Value &param01) = 0;
  virtual Json::Value get_transaction_count(const Json::Value &param01) = 0;
  virtual Json::Value get_executed_trx_count(const Json::Value &param01) = 0;
  virtual Json::Value get_executed_blk_count(const Json::Value &param01) = 0;
  virtual Json::Value get_dag_size(const Json::Value &param01) = 0;
  virtual Json::Value get_dag_blk_count(const Json::Value &param01) = 0;
  virtual Json::Value get_pbft_chain_size() = 0;
  virtual Json::Value get_pbft_chain_blocks(const Json::Value &param01) = 0;
};
