...
TEST_F(NetworkTest, transfer_lot_of_blocks) {
  ...
  const auto period_block_hash = nodes[0]->getDB()->getPeriodBlockHash(1);
  vdf_sortition::VdfSortition vdf(vdf_config, nodes[0]->getVrfSecretKey(), makeVrfInput(1, period_block_hash));
...
TEST_F(NetworkTest, node_sync) {
  ...
  vdf_sortition::VdfSortition vdf1(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  propose_level = 2;
  vdf_sortition::VdfSortition vdf2(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  propose_level = 3;
  vdf_sortition::VdfSortition vdf3(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  propose_level = 4;
  vdf_sortition::VdfSortition vdf4(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  propose_level = 5;
  vdf_sortition::VdfSortition vdf5(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  propose_level = 6;
  vdf_sortition::VdfSortition vdf6(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
...
TEST_F(NetworkTest, node_sync2) {
  ...
  // DAG block7
  propose_level = 3;
  vdf_sortition::VdfSortition vdf7(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  // DAG block8
  propose_level = 4;
  vdf_sortition::VdfSortition vdf8(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  // DAG block9
  propose_level = 2;
  vdf_sortition::VdfSortition vdf9(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  // DAG block10
  propose_level = 5;
  vdf_sortition::VdfSortition vdf10(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  // DAG block11
  propose_level = 3;
  vdf_sortition::VdfSortition vdf11(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
  ...
  // DAG block12
  propose_level = 3;
  vdf_sortition::VdfSortition vdf12(vdf_config, vrf_sk, makeVrfInput(propose_level, period_block_hash));
