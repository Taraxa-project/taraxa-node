...
TEST_F(NetworkTest, transfer_lot_of_blocks) {
  ...
  DagBlock blk(dag_genesis, 1, 1, {}, {samples::createSignedTrxSamples(0, 1, g_secret)[0]->getHash()}, vdf,
...
TEST_F(NetworkTest, node_sync) {
  ...
  DagBlock blk1(dag_genesis, propose_period, propose_level, {}, {g_signed_trx_samples[1]->getHash()}, vdf1, sk);
  ...
  DagBlock blk2(blk1.getHash(), propose_period, propose_level, {}, {g_signed_trx_samples[2]->getHash()}, vdf2, sk);
  ...
  DagBlock blk3(blk2.getHash(), propose_period, propose_level, {}, {g_signed_trx_samples[3]->getHash()}, vdf3, sk);
  ...
  DagBlock blk4(blk3.getHash(), propose_period, propose_level, {}, {g_signed_trx_samples[4]->getHash()}, vdf4, sk);
  ...
  DagBlock blk5(blk4.getHash(), propose_period, propose_level, {}, {g_signed_trx_samples[5]->getHash()}, vdf5, sk);
  ...
  DagBlock blk6(blk5.getHash(), propose_period, propose_level, {blk4.getHash(), blk3.getHash()},
                {g_signed_trx_samples[6]->getHash()}, vdf6, sk);
...
TEST_F(NetworkTest, node_pbft_sync) {
  ...
  vdf2.computeVdfSolution(vdf_config, blk1.getHash().asBytes());
  DagBlock blk2(blk1.getHash(), 1, 2, {}, {g_signed_trx_samples[2]->getHash(), g_signed_trx_samples[3]->getHash()},
                vdf2, sk);
...
TEST_F(NetworkTest, node_sync_with_transactions) {
  ...
  vdf_sortition::VdfSortition vdf1(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf1.computeVdfSolution(vdf_config, dag_genesis.asBytes());
  DagBlock blk1(dag_genesis, propose_period, propose_level, {},
  ...
  vdf_sortition::VdfSortition vdf5(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf5.computeVdfSolution(vdf_config, blk4.getHash().asBytes());
  DagBlock blk5(blk4.getHash(), propose_period, propose_level, {},
  ...
  vdf6.computeVdfSolution(vdf_config, blk5.getHash().asBytes());
  DagBlock blk6(blk5.getHash(), propose_period, propose_level, {blk4.getHash(), blk3.getHash()},
                {g_signed_trx_samples[9]->getHash()}, vdf6, sk);
...
TEST_F(NetworkTest, node_sync2) {
  ...
  vdf1.computeVdfSolution(vdf_config, dag_genesis.asBytes());
  DagBlock blk1(dag_genesis, propose_period, propose_level, {},
                {transactions[0]->getHash(), transactions[1]->getHash()}, vdf1, sk);
  SharedTransactions tr1({transactions[0], transactions[1]});
  // DAG block2
  propose_level = 1;
  vdf_sortition::VdfSortition vdf2(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf2.computeVdfSolution(vdf_config, dag_genesis.asBytes());
  DagBlock blk2(dag_genesis, propose_period, propose_level, {},
                {transactions[2]->getHash(), transactions[3]->getHash()}, vdf2, sk);
  SharedTransactions tr2({transactions[2], transactions[3]});
  // DAG block3
  propose_level = 2;
  vdf_sortition::VdfSortition vdf3(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf3.computeVdfSolution(vdf_config, blk1.getHash().asBytes());
  DagBlock blk3(blk1.getHash(), propose_period, propose_level, {},
                {transactions[4]->getHash(), transactions[5]->getHash()}, vdf3, sk);
  SharedTransactions tr3({transactions[4], transactions[5]});
  // DAG block4
  propose_level = 3;
  vdf_sortition::VdfSortition vdf4(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf4.computeVdfSolution(vdf_config, blk3.getHash().asBytes());
  DagBlock blk4(blk3.getHash(), propose_period, propose_level, {},
                {transactions[6]->getHash(), transactions[7]->getHash()}, vdf4, sk);
  SharedTransactions tr4({transactions[6], transactions[7]});
  // DAG block5
  propose_level = 2;
  vdf_sortition::VdfSortition vdf5(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf5.computeVdfSolution(vdf_config, blk2.getHash().asBytes());
  DagBlock blk5(blk2.getHash(), propose_period, propose_level, {},
                {transactions[8]->getHash(), transactions[9]->getHash()}, vdf5, sk);
  SharedTransactions tr5({transactions[8], transactions[9]});
  // DAG block6
  propose_level = 2;
  vdf_sortition::VdfSortition vdf6(vdf_config, vrf_sk, getRlpBytes(propose_level));
  vdf6.computeVdfSolution(vdf_config, blk1.getHash().asBytes());
  DagBlock blk6(blk1.getHash(), propose_period, propose_level, {},
                {transactions[10]->getHash(), transactions[11]->getHash()}, vdf6, sk);
  ...
  DagBlock blk7(blk6.getHash(), propose_period, propose_level, {},
                {transactions[12]->getHash(), transactions[13]->getHash()}, vdf7, sk);
  ...
  DagBlock blk8(blk1.getHash(), propose_period, propose_level, {blk7.getHash()},
  ...
  DagBlock blk9(blk1.getHash(), propose_period, propose_level, {},
                {transactions[16]->getHash(), transactions[17]->getHash()}, vdf9, sk);
  ...
  DagBlock blk10(blk8.getHash(), propose_period, propose_level, {},
                 {transactions[18]->getHash(), transactions[19]->getHash()}, vdf10, sk);
  ...
  DagBlock blk11(blk3.getHash(), propose_period, propose_level, {},
                 {transactions[20]->getHash(), transactions[21]->getHash()}, vdf11, sk);
  ...
  DagBlock blk12(blk5.getHash(), propose_period, propose_level, {},
                 {transactions[22]->getHash(), transactions[23]->getHash()}, vdf12, sk);
