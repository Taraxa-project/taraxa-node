...
TEST_F(P2PTest, capability_send_test) {
  ...
  auto thc1 = make_shared<TaraxaCapability>(host1, network_conf, GENESIS, addr_t(), nullptr, nullptr, nullptr, nullptr,
                                            nullptr, nullptr, nullptr, nullptr, 2000);
  host1.registerCapability(thc1);
  auto thc2 = make_shared<TaraxaCapability>(host2, network_conf, GENESIS, addr_t(), nullptr, nullptr, nullptr, nullptr,
                                            nullptr, nullptr, nullptr, nullptr, 2000);
...
TEST_F(P2PTest, block_propagate) {
  ...
  for (int i = 0; i < nodeCount; i++) {
    vCapabilities.push_back(make_shared<TaraxaCapability>(*vHosts[i], network_conf, GENESIS, addr_t(), nullptr, nullptr,
