    ...
    def __init__(self, cfg_file_path, wallet_file_path, mode: InitMode, default_w3_provider_type='http'):
        ...
        if isinstance(mode, Node.ManagedProcessInitMode):
            ...
            with open(datadir_cfg_file_path, mode="r") as f:
                ...
                cfg["chain_config"]["final_chain"]["state"]["genesis_balances"]["de2b1203d72d3549ee2f733b00b2789414c7cea5"] = "0x1ffffffffffffff"
                cfg["chain_config"]["final_chain"]["state"]["genesis_balances"]["973ecb1c08c8eb5a7eaa0d3fd3aab7924f2838b0"] = "0x1ffffffffffffff"
